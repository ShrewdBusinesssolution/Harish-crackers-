...
import com.vedi.vedi_box.databinding.NotificationItemBinding;
        ...
        holder.notificationItemBinding.notificationImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (expand) {
                    ...
                    holder.notificationItemBinding.notificationImageView.setImageDrawable(ContextCompat.getDrawable(mcontext, R.drawable.ic__arrow_down));
