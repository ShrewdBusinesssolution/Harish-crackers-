...
public class ViewShopListAdapter extends RecyclerView.Adapter<ViewShopListAdapter.ShopViewHolder> implements Filterable {
    ...
    public ViewShopListAdapter(Context context, List<Product> products, ShopInterface shopInterface) {
        mcontext = context;
    ...
    public void onBindViewHolder(@NonNull @NotNull ShopViewHolder holder, int position) {
        ...
        Log.e("ViewShopAdapter","DATA:::"+cartList.size());
